...
import { displaypic } from '@/lib/data';
import { useSectionInView } from "@/lib/hooks";
import { useActiveSectionContext } from '@/context/active-section-intersection';


//var  imageURL = displaypic;
    ...
    id="home" className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
      <div className='flex items-center justify-center'>
        <div className='relative'>
            ...
            >
            <Image 
            src = {require("/public/port.png")}
            alt="Rahmatunnisa protrait"
            width="192"
            height="192"
            quality="95"
            priority={true}
      ...
      >
      <span className="font-bold">Hello, I am Rahmat.</span> I am a{" "}
      ...
      >
        ...
        outline-none focus:scale-110 hover:scale-110
         active:scale-105 transition cursor-pointer border border-black/10 dark:bg-white/10' href="/CV.pdf" download={true}>
        ...
        href='https://www.linkedin.com/in/rahmatunnisa-khatoon/' target='_blank'
        >
            <BsLinkedin />
        </a>
        ...
        focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950
        active:scale-105 transition cursor-pointer border border-black/10 dark:bg-white/10 dark:text-white/60'
        href='https://github.com/rahmat06-khatoon' target='_blank'
        >
            <FaGithubSquare />
        </a>
      </motion.div>
